...
# ╔═╡ 109de0d6-cac1-11ee-2ae3-3d856429f775
using SpecialFunctions, StatsPlots, Turing,Plots,LogExpFunctions

# ╔═╡ 1b33f8b8-0574-49c7-ad70-802da96ae709
using Random

# ╔═╡ 13849765-0edc-41e7-84fa-1db446b133e1
plot(Gumbel(0,1))

# ╔═╡ 54f89229-61de-4f40-8188-677cdb75e3c2
...
# ╔═╡ 031e59f3-6396-4b73-b30b-33a8958eb12c
struct GumbelSoftmax <: ContinuousMultivariateDistribution
	π::Vector{Float64}
	τ::Float64
end

# ╔═╡ 0ed61206-4570-42f2-b203-b0c781f42fa3
...
# ╔═╡ cc4692df-8fb7-492d-ab5e-d274d020c4c7
...
# ╔═╡ 8f1fac86-7b62-4ce3-a552-978d9d73a87c
...
# ╔═╡ 10688d11-53f9-4493-b771-7b2fbfc59945
begin 
	x = 1:1:50
	y = [(rand([-3,3]) .* x) .+ randn(50) for i in 1:60]
	y = reduce(hcat,y)
end

# ╔═╡ 3211e910-9a2a-4b80-8648-d710939a5fa0
plot(x,y,label=:none)

# ╔═╡ 5680d194-7b39-456b-aa7d-f8f593e8e486
Bijectors.bijector(d::GumbelSoftmax) = SimplexBijector()

# ╔═╡ 8e786653-df0c-454c-8154-3e24b1c20cfe
Base.length(d::GumbelSoftmax) = length(d.π)

# ╔═╡ 0c1d8935-d7ea-4ee0-9aae-75fa8f5328ab
begin 
	r = GumbelSoftmax([0.5,0.5],.1)
	@assert log(pdf(r,[.1,.9])) ≈ logpdf(r,[.1,.9])
end

# ╔═╡ fc34ee96-de19-4a64-840b-d30e07a6952f


# ╔═╡ 185bdf79-cac8-4ad2-827d-df6a3858ef77
y

# ╔═╡ a38ec717-262f-4d57-be34-a3a9537c3f27
rand(j)

# ╔═╡ a0d15dcb-c514-44ae-a5f4-a662eb26212a
u = filldist(Dirichlet(ones(2)),10)

# ╔═╡ bcf8a0e0-59b6-4aa9-99ea-a92cf64021d3
rand(u,10)
...
manifest_format = "2.0"
project_hash = "013ca8fae350ce16f0885daf198af9be13edc236"
...
git-tree-sha1 = "88b833ac38dd47b17fa78092f97980cdf02462c4"
